...
%global pkg_name rqml_default_plugins
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rqml-default-plugins
Version:        3.26.42
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Stefan Fabian <fabian@sim.tu-darmstadt.de> - 3.26.42-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Stefan Fabian <fabian@sim.tu-darmstadt.de> - 3.26.42-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Stefan Fabian <fabian@sim.tu-darmstadt.de> - 3.26.42-1
- Autogenerated by Bloom
