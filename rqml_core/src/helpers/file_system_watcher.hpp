...
#ifndef RQML_FILE_WATCHER_H
#define RQML_FILE_WATCHER_H
...
public:
  ...
  //! Returns true if one of the watched paths has changed since the last call to checkForChanges().
...
private:
  ...
  std::map<std::string, int, std::less<>> watched_directories_;
